document.addEventListener('DOMContentLoaded', function () {
    ...
    const buttons = [
        ...
        { element: document.querySelector('.banshee_JS'), original: 'ZineButtons/bansheebutton1.png', hover: 'ZineButtons/bansheebutton2.png' },
        { element: document.querySelector('.dream_JS'), original: 'ZineButtons/dreambutton1.png', hover: 'ZineButtons/dreambutton2.png' },
        { element: document.querySelector('.super_JS'), original: 'ZineButtons/superkidbutton1.png', hover: 'ZineButtons/superkidbuttonopen2.png' },
